...
// Insert into the single companies table with 'pending' status instead of 'active'
$insert_stmt = $conn->prepare("INSERT INTO companies (company_id, company_name, industry_type, company_email, year_established, password, contact_name, designation, contact_phone, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, 'pending')");
